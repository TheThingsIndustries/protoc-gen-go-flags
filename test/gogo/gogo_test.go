...
var testMessagesWithGoGoOptions = []struct {
...
}{
	{
		...
		arguments: []string{},
		expectedMessage: MessageWithGoGoOptions{
			NonNullableEUIWithCustomNameAndType: types.EUI64{},
		},
		expectedMask: nil,
	},
	{
		...
		expectedMessage: MessageWithGoGoOptions{
			...
			EUIWithCustomNameAndType:            unmarshalEUI64("0102030405060708"),
			NonNullableEUIWithCustomNameAndType: *unmarshalEUI64("0102030405060708"),
			EUIsWithCustomNameAndType: []types.EUI64{
				*unmarshalEUI64("0102030405060708"),
				*unmarshalEUI64("0102030405060707"),
				*unmarshalEUI64("0102030405060709"),
			},
		},
		expectedMask: []string{
