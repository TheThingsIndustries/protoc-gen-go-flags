...
func AddSelectFlagsForMessageWithWKTs(flags *pflag.FlagSet, prefix string) {
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("double-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("double-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("double-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("double-values", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("float-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("float-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("float-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("float-values", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("int32-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("int32-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("int32-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("int32-values", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("int64-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("int64-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("int64-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("int64-values", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("uint32-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("uint32-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("uint32-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("uint32-values", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("uint64-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("uint64-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("uint64-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("uint64-values", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("bool-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("bool-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("bool-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("bool-values", prefix), false)))
	...
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-values", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("bytes-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("bytes-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("bytes-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("bytes-values", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("empty-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("empty-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("empty-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("empty-values", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("timestamp-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("timestamp-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("timestamp-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("timestamp-values", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("duration-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("duration-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("duration-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("duration-values", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("field-mask-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("field-mask-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("field-mask-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("field-mask-values", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value-values", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("list-value-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("list-value-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("list-value-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("list-value-values", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("struct-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("struct-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("struct-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("struct-values", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("any-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("any-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("any-values", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("any-values", prefix), false)))
}
...
func AddSetFlagsForMessageWithWKTs(flags *pflag.FlagSet, prefix string) {
	flags.AddFlag(flagsplugin.NewFloat64Flag(flagsplugin.Prefix("double-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("double-value.value", prefix), flagsplugin.Prefix("double-value", prefix))
	flags.AddFlag(flagsplugin.NewFloat64SliceFlag(flagsplugin.Prefix("double-values", prefix), ""))
	flags.AddFlag(flagsplugin.NewFloat32Flag(flagsplugin.Prefix("float-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("float-value.value", prefix), flagsplugin.Prefix("float-value", prefix))
	flags.AddFlag(flagsplugin.NewFloat32SliceFlag(flagsplugin.Prefix("float-values", prefix), ""))
	flags.AddFlag(flagsplugin.NewInt32Flag(flagsplugin.Prefix("int32-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("int32-value.value", prefix), flagsplugin.Prefix("int32-value", prefix))
	flags.AddFlag(flagsplugin.NewInt32SliceFlag(flagsplugin.Prefix("int32-values", prefix), ""))
	flags.AddFlag(flagsplugin.NewInt64Flag(flagsplugin.Prefix("int64-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("int64-value.value", prefix), flagsplugin.Prefix("int64-value", prefix))
	flags.AddFlag(flagsplugin.NewInt64SliceFlag(flagsplugin.Prefix("int64-values", prefix), ""))
	flags.AddFlag(flagsplugin.NewUint32Flag(flagsplugin.Prefix("uint32-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("uint32-value.value", prefix), flagsplugin.Prefix("uint32-value", prefix))
	flags.AddFlag(flagsplugin.NewUint32SliceFlag(flagsplugin.Prefix("uint32-values", prefix), ""))
	flags.AddFlag(flagsplugin.NewUint64Flag(flagsplugin.Prefix("uint64-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("uint64-value.value", prefix), flagsplugin.Prefix("uint64-value", prefix))
	flags.AddFlag(flagsplugin.NewUint64SliceFlag(flagsplugin.Prefix("uint64-values", prefix), ""))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("bool-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("bool-value.value", prefix), flagsplugin.Prefix("bool-value", prefix))
	flags.AddFlag(flagsplugin.NewBoolSliceFlag(flagsplugin.Prefix("bool-values", prefix), ""))
	flags.AddFlag(flagsplugin.NewStringFlag(flagsplugin.Prefix("string-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("string-value.value", prefix), flagsplugin.Prefix("string-value", prefix))
	flags.AddFlag(flagsplugin.NewStringSliceFlag(flagsplugin.Prefix("string-values", prefix), ""))
	flags.AddFlag(flagsplugin.NewBytesFlag(flagsplugin.Prefix("bytes-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("bytes-value.value", prefix), flagsplugin.Prefix("bytes-value", prefix))
	flags.AddFlag(flagsplugin.NewBytesSliceFlag(flagsplugin.Prefix("bytes-values", prefix), ""))
	...
	flags.AddFlag(flagsplugin.NewTimestampFlag(flagsplugin.Prefix("timestamp-value", prefix), ""))
	flags.AddFlag(flagsplugin.NewTimestampSliceFlag(flagsplugin.Prefix("timestamp-values", prefix), ""))
	flags.AddFlag(flagsplugin.NewDurationFlag(flagsplugin.Prefix("duration-value", prefix), ""))
	flags.AddFlag(flagsplugin.NewDurationSliceFlag(flagsplugin.Prefix("duration-values", prefix), ""))
	flags.AddFlag(flagsplugin.NewStringSliceFlag(flagsplugin.Prefix("field-mask-value", prefix), ""))
...
func (m *MessageWithWKTs) SetFromFlags(flags *pflag.FlagSet, prefix string) (paths []string, err error) {
	if val, selected, err := flagsplugin.GetFloat64(flags, flagsplugin.Prefix("double_value.value", prefix)); err != nil {
		...
		m.DoubleValue = &types.DoubleValue{Value: val}
		paths = append(paths, flagsplugin.Prefix("double_value", prefix))
	}
	...
	if val, selected, err := flagsplugin.GetFloat32(flags, flagsplugin.Prefix("float_value.value", prefix)); err != nil {
		...
		m.FloatValue = &types.FloatValue{Value: val}
		paths = append(paths, flagsplugin.Prefix("float_value", prefix))
	}
	...
	if val, selected, err := flagsplugin.GetInt32(flags, flagsplugin.Prefix("int32_value.value", prefix)); err != nil {
		...
		m.Int32Value = &types.Int32Value{Value: val}
		paths = append(paths, flagsplugin.Prefix("int32_value", prefix))
	}
	...
	if val, selected, err := flagsplugin.GetInt64(flags, flagsplugin.Prefix("int64_value.value", prefix)); err != nil {
		...
		m.Int64Value = &types.Int64Value{Value: val}
		paths = append(paths, flagsplugin.Prefix("int64_value", prefix))
	}
	...
	if val, selected, err := flagsplugin.GetUint32(flags, flagsplugin.Prefix("uint32_value.value", prefix)); err != nil {
		...
		m.Uint32Value = &types.UInt32Value{Value: val}
		paths = append(paths, flagsplugin.Prefix("uint32_value", prefix))
	}
	...
	if val, selected, err := flagsplugin.GetUint64(flags, flagsplugin.Prefix("uint64_value.value", prefix)); err != nil {
		...
		m.Uint64Value = &types.UInt64Value{Value: val}
		paths = append(paths, flagsplugin.Prefix("uint64_value", prefix))
	}
	...
	if val, selected, err := flagsplugin.GetBool(flags, flagsplugin.Prefix("bool_value.value", prefix)); err != nil {
		...
		m.BoolValue = &types.BoolValue{Value: val}
		paths = append(paths, flagsplugin.Prefix("bool_value", prefix))
	}
	...
	if val, selected, err := flagsplugin.GetString(flags, flagsplugin.Prefix("string_value.value", prefix)); err != nil {
		...
		m.StringValue = &types.StringValue{Value: val}
		paths = append(paths, flagsplugin.Prefix("string_value", prefix))
	}
	...
	if val, selected, err := flagsplugin.GetBytes(flags, flagsplugin.Prefix("bytes_value.value", prefix)); err != nil {
		...
		m.BytesValue = &types.BytesValue{Value: val}
		paths = append(paths, flagsplugin.Prefix("bytes_value", prefix))
	}
	...
	if val, selected, err := flagsplugin.GetTimestamp(flags, flagsplugin.Prefix("timestamp_value", prefix)); err != nil {
		...
		m.TimestampValue = gogo.SetTimestamp(val)
		paths = append(paths, flagsplugin.Prefix("timestamp_value", prefix))
	}
	...
	if val, selected, err := flagsplugin.GetDuration(flags, flagsplugin.Prefix("duration_value", prefix)); err != nil {
		...
		m.DurationValue = gogo.SetDuration(val)
		paths = append(paths, flagsplugin.Prefix("duration_value", prefix))
	}
	...
	if val, selected, err := flagsplugin.GetStringSlice(flags, flagsplugin.Prefix("field_mask_value", prefix)); err != nil {
		...
		m.FieldMaskValue = gogo.SetFieldMask(val)
		paths = append(paths, flagsplugin.Prefix("field_mask_value", prefix))
	}
...
func AddSelectFlagsForMessageWithOneofWKTs(flags *pflag.FlagSet, prefix string) {
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.double-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.double-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.float-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.float-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.int32-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.int32-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.int64-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.int64-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.uint32-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.uint32-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.uint64-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.uint64-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.bool-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.bool-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.string-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.string-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.bytes-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.bytes-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.empty-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.empty-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.timestamp-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.timestamp-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.duration-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.duration-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.field-mask-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.field-mask-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.value-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.value-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.list-value-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.list-value-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.struct-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.struct-value", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.any-value", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("value.any-value", prefix), false)))
}
...
func AddSetFlagsForMessageWithOneofWKTs(flags *pflag.FlagSet, prefix string) {
	flags.AddFlag(flagsplugin.NewFloat64Flag(flagsplugin.Prefix("value.double-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("value.double-value.value", prefix), flagsplugin.Prefix("value.double-value", prefix))
	flags.AddFlag(flagsplugin.NewFloat32Flag(flagsplugin.Prefix("value.float-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("value.float-value.value", prefix), flagsplugin.Prefix("value.float-value", prefix))
	flags.AddFlag(flagsplugin.NewInt32Flag(flagsplugin.Prefix("value.int32-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("value.int32-value.value", prefix), flagsplugin.Prefix("value.int32-value", prefix))
	flags.AddFlag(flagsplugin.NewInt64Flag(flagsplugin.Prefix("value.int64-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("value.int64-value.value", prefix), flagsplugin.Prefix("value.int64-value", prefix))
	flags.AddFlag(flagsplugin.NewUint32Flag(flagsplugin.Prefix("value.uint32-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("value.uint32-value.value", prefix), flagsplugin.Prefix("value.uint32-value", prefix))
	flags.AddFlag(flagsplugin.NewUint64Flag(flagsplugin.Prefix("value.uint64-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("value.uint64-value.value", prefix), flagsplugin.Prefix("value.uint64-value", prefix))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("value.bool-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("value.bool-value.value", prefix), flagsplugin.Prefix("value.bool-value", prefix))
	flags.AddFlag(flagsplugin.NewStringFlag(flagsplugin.Prefix("value.string-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("value.string-value.value", prefix), flagsplugin.Prefix("value.string-value", prefix))
	flags.AddFlag(flagsplugin.NewBytesFlag(flagsplugin.Prefix("value.bytes-value.value", prefix), ""))
	flagsplugin.AddAlias(flags, flagsplugin.Prefix("value.bytes-value.value", prefix), flagsplugin.Prefix("value.bytes-value", prefix))
	// FIXME: Skipping EmptyValue because this WKT is currently not supported.
	flags.AddFlag(flagsplugin.NewTimestampFlag(flagsplugin.Prefix("value.timestamp-value", prefix), ""))
	flags.AddFlag(flagsplugin.NewDurationFlag(flagsplugin.Prefix("value.duration-value", prefix), ""))
	flags.AddFlag(flagsplugin.NewStringSliceFlag(flagsplugin.Prefix("value.field-mask-value", prefix), ""))
	// FIXME: Skipping ValueValue because this WKT is currently not supported.
	// FIXME: Skipping ListValueValue because this WKT is currently not supported.
	// FIXME: Skipping StructValue because this WKT is currently not supported.
	// FIXME: Skipping AnyValue because this WKT is currently not supported.
...
func (m *MessageWithOneofWKTs) SetFromFlags(flags *pflag.FlagSet, prefix string) (paths []string, err error) {
	if val, selected, err := flagsplugin.GetFloat64(flags, flagsplugin.Prefix("value.double_value.value", prefix)); err != nil {
		...
		ov.DoubleValue = &types.DoubleValue{Value: val}
		paths = append(paths, flagsplugin.Prefix("value.double_value", prefix))
		m.Value = ov
	}
	if val, selected, err := flagsplugin.GetFloat32(flags, flagsplugin.Prefix("value.float_value.value", prefix)); err != nil {
		...
		ov.FloatValue = &types.FloatValue{Value: val}
		paths = append(paths, flagsplugin.Prefix("value.float_value", prefix))
		m.Value = ov
	}
	if val, selected, err := flagsplugin.GetInt32(flags, flagsplugin.Prefix("value.int32_value.value", prefix)); err != nil {
		...
		ov.Int32Value = &types.Int32Value{Value: val}
		paths = append(paths, flagsplugin.Prefix("value.int32_value", prefix))
		m.Value = ov
	}
	if val, selected, err := flagsplugin.GetInt64(flags, flagsplugin.Prefix("value.int64_value.value", prefix)); err != nil {
		...
		ov.Int64Value = &types.Int64Value{Value: val}
		paths = append(paths, flagsplugin.Prefix("value.int64_value", prefix))
		m.Value = ov
	}
	if val, selected, err := flagsplugin.GetUint32(flags, flagsplugin.Prefix("value.uint32_value.value", prefix)); err != nil {
		...
		ov.Uint32Value = &types.UInt32Value{Value: val}
		paths = append(paths, flagsplugin.Prefix("value.uint32_value", prefix))
		m.Value = ov
	}
	if val, selected, err := flagsplugin.GetUint64(flags, flagsplugin.Prefix("value.uint64_value.value", prefix)); err != nil {
		...
		ov.Uint64Value = &types.UInt64Value{Value: val}
		paths = append(paths, flagsplugin.Prefix("value.uint64_value", prefix))
		m.Value = ov
	}
	if val, selected, err := flagsplugin.GetBool(flags, flagsplugin.Prefix("value.bool_value.value", prefix)); err != nil {
		...
		ov.BoolValue = &types.BoolValue{Value: val}
		paths = append(paths, flagsplugin.Prefix("value.bool_value", prefix))
		m.Value = ov
	}
	if val, selected, err := flagsplugin.GetString(flags, flagsplugin.Prefix("value.string_value.value", prefix)); err != nil {
		...
		ov.StringValue = &types.StringValue{Value: val}
		paths = append(paths, flagsplugin.Prefix("value.string_value", prefix))
		m.Value = ov
	}
	if val, selected, err := flagsplugin.GetBytes(flags, flagsplugin.Prefix("value.bytes_value.value", prefix)); err != nil {
		...
		ov.BytesValue = &types.BytesValue{Value: val}
		paths = append(paths, flagsplugin.Prefix("value.bytes_value", prefix))
		m.Value = ov
	}
	// FIXME: Skipping EmptyValue because this WKT is not supported.
	if val, selected, err := flagsplugin.GetTimestamp(flags, flagsplugin.Prefix("value.timestamp_value", prefix)); err != nil {
		...
		ov.TimestampValue = gogo.SetTimestamp(val)
		paths = append(paths, flagsplugin.Prefix("value.timestamp_value", prefix))
		m.Value = ov
	}
	if val, selected, err := flagsplugin.GetDuration(flags, flagsplugin.Prefix("value.duration_value", prefix)); err != nil {
		...
		ov.DurationValue = gogo.SetDuration(val)
		paths = append(paths, flagsplugin.Prefix("value.duration_value", prefix))
		m.Value = ov
	}
	if val, selected, err := flagsplugin.GetStringSlice(flags, flagsplugin.Prefix("value.field_mask_value", prefix)); err != nil {
		...
		ov.FieldMaskValue = gogo.SetFieldMask(val)
		paths = append(paths, flagsplugin.Prefix("value.field_mask_value", prefix))
		m.Value = ov
	}
	// FIXME: Skipping ValueValue because this WKT is not supported.
...
func AddSelectFlagsForMessageWithWKTMaps(flags *pflag.FlagSet, prefix string) {
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-double-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-double-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-float-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-float-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-int32-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-int32-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-int64-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-int64-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-uint32-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-uint32-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-uint64-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-uint64-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-bool-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-bool-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-string-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-string-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-bytes-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-bytes-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-empty-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-empty-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-timestamp-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-timestamp-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-duration-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-duration-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-field-mask-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-field-mask-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-value-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-value-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-list-value-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-list-value-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-struct-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-struct-map", prefix), false)))
	flags.AddFlag(flagsplugin.NewBoolFlag(flagsplugin.Prefix("string-any-map", prefix), flagsplugin.SelectDesc(flagsplugin.Prefix("string-any-map", prefix), false)))
}
...
func AddSetFlagsForMessageWithWKTMaps(flags *pflag.FlagSet, prefix string) {
	flags.AddFlag(flagsplugin.NewStringFloat64MapFlag(flagsplugin.Prefix("string-double-map", prefix), ""))
	flags.AddFlag(flagsplugin.NewStringFloat32MapFlag(flagsplugin.Prefix("string-float-map", prefix), ""))
	flags.AddFlag(flagsplugin.NewStringInt32MapFlag(flagsplugin.Prefix("string-int32-map", prefix), ""))
	flags.AddFlag(flagsplugin.NewStringInt64MapFlag(flagsplugin.Prefix("string-int64-map", prefix), ""))
	flags.AddFlag(flagsplugin.NewStringUint32MapFlag(flagsplugin.Prefix("string-uint32-map", prefix), ""))
	flags.AddFlag(flagsplugin.NewStringUint64MapFlag(flagsplugin.Prefix("string-uint64-map", prefix), ""))
	flags.AddFlag(flagsplugin.NewStringBoolMapFlag(flagsplugin.Prefix("string-bool-map", prefix), ""))
	flags.AddFlag(flagsplugin.NewStringStringMapFlag(flagsplugin.Prefix("string-string-map", prefix), ""))
	flags.AddFlag(flagsplugin.NewStringBytesMapFlag(flagsplugin.Prefix("string-bytes-map", prefix), ""))
	// FIXME: Skipping StringEmptyMap because maps with message value types are currently not supported.
	flags.AddFlag(flagsplugin.NewStringTimestampMapFlag(flagsplugin.Prefix("string-timestamp-map", prefix), ""))
	flags.AddFlag(flagsplugin.NewStringDurationMapFlag(flagsplugin.Prefix("string-duration-map", prefix), ""))
...
func (m *MessageWithWKTMaps) SetFromFlags(flags *pflag.FlagSet, prefix string) (paths []string, err error) {
	if val, selected, err := flagsplugin.GetStringFloat64Map(flags, flagsplugin.Prefix("string_double_map", prefix)); err != nil {
		...
		m.StringDoubleMap = make(map[string]*types.DoubleValue)
		for key, value := range val {
			m.StringDoubleMap[key] = &types.DoubleValue{Value: value}
		}
		paths = append(paths, flagsplugin.Prefix("string_double_map", prefix))
	}
	if val, selected, err := flagsplugin.GetStringFloat32Map(flags, flagsplugin.Prefix("string_float_map", prefix)); err != nil {
		...
		m.StringFloatMap = make(map[string]*types.FloatValue)
		for key, value := range val {
			m.StringFloatMap[key] = &types.FloatValue{Value: value}
		}
		paths = append(paths, flagsplugin.Prefix("string_float_map", prefix))
	}
	if val, selected, err := flagsplugin.GetStringInt32Map(flags, flagsplugin.Prefix("string_int32_map", prefix)); err != nil {
		...
		m.StringInt32Map = make(map[string]*types.Int32Value)
		for key, value := range val {
			m.StringInt32Map[key] = &types.Int32Value{Value: value}
		}
		paths = append(paths, flagsplugin.Prefix("string_int32_map", prefix))
	}
	if val, selected, err := flagsplugin.GetStringInt64Map(flags, flagsplugin.Prefix("string_int64_map", prefix)); err != nil {
		...
		m.StringInt64Map = make(map[string]*types.Int64Value)
		for key, value := range val {
			m.StringInt64Map[key] = &types.Int64Value{Value: value}
		}
		paths = append(paths, flagsplugin.Prefix("string_int64_map", prefix))
	}
	if val, selected, err := flagsplugin.GetStringUint32Map(flags, flagsplugin.Prefix("string_uint32_map", prefix)); err != nil {
		...
		m.StringUint32Map = make(map[string]*types.UInt32Value)
		for key, value := range val {
			m.StringUint32Map[key] = &types.UInt32Value{Value: value}
		}
		paths = append(paths, flagsplugin.Prefix("string_uint32_map", prefix))
	}
	if val, selected, err := flagsplugin.GetStringUint64Map(flags, flagsplugin.Prefix("string_uint64_map", prefix)); err != nil {
		...
		m.StringUint64Map = make(map[string]*types.UInt64Value)
		for key, value := range val {
			m.StringUint64Map[key] = &types.UInt64Value{Value: value}
		}
		paths = append(paths, flagsplugin.Prefix("string_uint64_map", prefix))
	}
	if val, selected, err := flagsplugin.GetStringBoolMap(flags, flagsplugin.Prefix("string_bool_map", prefix)); err != nil {
		...
		m.StringBoolMap = make(map[string]*types.BoolValue)
		for key, value := range val {
			m.StringBoolMap[key] = &types.BoolValue{Value: value}
		}
		paths = append(paths, flagsplugin.Prefix("string_bool_map", prefix))
	}
	if val, selected, err := flagsplugin.GetStringStringMap(flags, flagsplugin.Prefix("string_string_map", prefix)); err != nil {
		...
		m.StringStringMap = make(map[string]*types.StringValue)
		for key, value := range val {
			m.StringStringMap[key] = &types.StringValue{Value: value}
		}
		paths = append(paths, flagsplugin.Prefix("string_string_map", prefix))
	}
	if val, selected, err := flagsplugin.GetStringBytesMap(flags, flagsplugin.Prefix("string_bytes_map", prefix)); err != nil {
		...
		m.StringBytesMap = make(map[string]*types.BytesValue)
		for key, value := range val {
			m.StringBytesMap[key] = &types.BytesValue{Value: value}
		}
		paths = append(paths, flagsplugin.Prefix("string_bytes_map", prefix))
	}
	// FIXME: Skipping StringEmptyMap because maps with message value types are currently not supported.
	if val, selected, err := flagsplugin.GetStringTimestampMap(flags, flagsplugin.Prefix("string_timestamp_map", prefix)); err != nil {
		...
		m.StringTimestampMap = make(map[string]*types.Timestamp)
		for key, value := range val {
			m.StringTimestampMap[key] = gogo.SetTimestamp(value)
		}
		paths = append(paths, flagsplugin.Prefix("string_timestamp_map", prefix))
	}
	if val, selected, err := flagsplugin.GetStringDurationMap(flags, flagsplugin.Prefix("string_duration_map", prefix)); err != nil {
		...
		m.StringDurationMap = make(map[string]*types.Duration)
		for key, value := range val {
			m.StringDurationMap[key] = gogo.SetDuration(value)
		}
		paths = append(paths, flagsplugin.Prefix("string_duration_map", prefix))
	}
	// FIXME: Skipping StringFieldMaskMap because maps with message value types are currently not supported.
