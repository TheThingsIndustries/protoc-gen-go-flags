...
const file_scalars_proto_rawDesc = "" +
	"\n" +
	"\rscalars.proto\x12\x14thethings.flags.test\x1a!thethings/flags/annotations.proto\"\xf6\v\n" +
	...
	"bytesValue\x12!\n" +
	"\fbytes_values\x18\x1e \x03(\fR\vbytesValues\x12\xc7\x01\n" +
	"\x0fhex_bytes_value\x18\x1f \x01(\fB\x9e\x01\xf2\xaa\x19\x99\x01\x1aNgithub.com/TheThingsIndustries/protoc-gen-go-flags/flagsplugin.NewHexBytesFlag\"Ggithub.com/TheThingsIndustries/protoc-gen-go-flags/flagsplugin.GetBytesR\rhexBytesValue\x12\xd3\x01\n" +
	"\x10hex_bytes_values\x18  \x03(\fB\xa8\x01\xf2\xaa\x19\xa3\x01\x1aSgithub.com/TheThingsIndustries/protoc-gen-go-flags/flagsplugin.NewHexBytesSliceFlag\"Lgithub.com/TheThingsIndustries/protoc-gen-go-flags/flagsplugin.GetBytesSliceR\x0ehexBytesValues:\b\xf2\xaa\x19\x04\b\x01\x10\x01\"\xa3\x06\n" +
	...
	"bytesValue\x12\xc9\x01\n" +
	"\x0fhex_bytes_value\x18\x10 \x01(\fB\x9e\x01\xf2\xaa\x19\x99\x01\x1aNgithub.com/TheThingsIndustries/protoc-gen-go-flags/flagsplugin.NewHexBytesFlag\"Ggithub.com/TheThingsIndustries/protoc-gen-go-flags/flagsplugin.GetBytesH\x00R\rhexBytesValue:\b\xf2\xaa\x19\x04\b\x01\x10\x01B\a\n" +
	"\x05value\"\xbd$\n" +
	"\x15MessageWithScalarMaps\x12l\n" +
	"\x11string_double_map\x18\x01 \x03(\v2@.thethings.flags.test.MessageWithScalarMaps.StringDoubleMapEntryR\x0fstringDoubleMap\x12i\n" +
	"\x10string_float_map\x18\x03 \x03(\v2?.thethings.flags.test.MessageWithScalarMaps.StringFloatMapEntryR\x0estringFloatMap\x12i\n" +
	"\x10string_int32_map\x18\x05 \x03(\v2?.thethings.flags.test.MessageWithScalarMaps.StringInt32MapEntryR\x0estringInt32Map\x12i\n" +
	"\x10int32_string_map\x18\x06 \x03(\v2?.thethings.flags.test.MessageWithScalarMaps.Int32StringMapEntryR\x0eint32StringMap\x12i\n" +
	"\x10string_int64_map\x18\a \x03(\v2?.thethings.flags.test.MessageWithScalarMaps.StringInt64MapEntryR\x0estringInt64Map\x12i\n" +
	"\x10int64_string_map\x18\b \x03(\v2?.thethings.flags.test.MessageWithScalarMaps.Int64StringMapEntryR\x0eint64StringMap\x12l\n" +
	"\x11string_uint32_map\x18\t \x03(\v2@.thethings.flags.test.MessageWithScalarMaps.StringUint32MapEntryR\x0fstringUint32Map\x12l\n" +
	"\x11uint32_string_map\x18\n" +
	" \x03(\v2@.thethings.flags.test.MessageWithScalarMaps.Uint32StringMapEntryR\x0fuint32StringMap\x12l\n" +
	"\x11string_uint64_map\x18\v \x03(\v2@.thethings.flags.test.MessageWithScalarMaps.StringUint64MapEntryR\x0fstringUint64Map\x12l\n" +
	"\x11uint64_string_map\x18\f \x03(\v2@.thethings.flags.test.MessageWithScalarMaps.Uint64StringMapEntryR\x0fuint64StringMap\x12l\n" +
	"\x11string_sint32_map\x18\r \x03(\v2@.thethings.flags.test.MessageWithScalarMaps.StringSint32MapEntryR\x0fstringSint32Map\x12l\n" +
	"\x11sint32_string_map\x18\x0e \x03(\v2@.thethings.flags.test.MessageWithScalarMaps.Sint32StringMapEntryR\x0fsint32StringMap\x12l\n" +
	"\x11string_sint64_map\x18\x0f \x03(\v2@.thethings.flags.test.MessageWithScalarMaps.StringSint64MapEntryR\x0fstringSint64Map\x12l\n" +
	"\x11sint64_string_map\x18\x10 \x03(\v2@.thethings.flags.test.MessageWithScalarMaps.Sint64StringMapEntryR\x0fsint64StringMap\x12o\n" +
	"\x12string_fixed32_map\x18\x11 \x03(\v2A.thethings.flags.test.MessageWithScalarMaps.StringFixed32MapEntryR\x10stringFixed32Map\x12o\n" +
	"\x12fixed32_string_map\x18\x12 \x03(\v2A.thethings.flags.test.MessageWithScalarMaps.Fixed32StringMapEntryR\x10fixed32StringMap\x12o\n" +
	"\x12string_fixed64_map\x18\x13 \x03(\v2A.thethings.flags.test.MessageWithScalarMaps.StringFixed64MapEntryR\x10stringFixed64Map\x12o\n" +
	"\x12fixed64_string_map\x18\x14 \x03(\v2A.thethings.flags.test.MessageWithScalarMaps.Fixed64StringMapEntryR\x10fixed64StringMap\x12r\n" +
	"\x13string_sfixed32_map\x18\x15 \x03(\v2B.thethings.flags.test.MessageWithScalarMaps.StringSfixed32MapEntryR\x11stringSfixed32Map\x12r\n" +
	"\x13sfixed32_string_map\x18\x16 \x03(\v2B.thethings.flags.test.MessageWithScalarMaps.Sfixed32StringMapEntryR\x11sfixed32StringMap\x12r\n" +
	"\x13string_sfixed64_map\x18\x17 \x03(\v2B.thethings.flags.test.MessageWithScalarMaps.StringSfixed64MapEntryR\x11stringSfixed64Map\x12r\n" +
	"\x13sfixed64_string_map\x18\x18 \x03(\v2B.thethings.flags.test.MessageWithScalarMaps.Sfixed64StringMapEntryR\x11sfixed64StringMap\x12f\n" +
	"\x0fstring_bool_map\x18\x19 \x03(\v2>.thethings.flags.test.MessageWithScalarMaps.StringBoolMapEntryR\rstringBoolMap\x12f\n" +
	"\x0fbool_string_map\x18\x1a \x03(\v2>.thethings.flags.test.MessageWithScalarMaps.BoolStringMapEntryR\rboolStringMap\x12l\n" +
	"\x11string_string_map\x18\x1b \x03(\v2@.thethings.flags.test.MessageWithScalarMaps.StringStringMapEntryR\x0fstringStringMap\x12i\n" +
	"\x10string_bytes_map\x18\x1d \x03(\v2?.thethings.flags.test.MessageWithScalarMaps.StringBytesMapEntryR\x0estringBytesMap\x1aB\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05value:\x028\x01:\b\xf2\xaa\x19\x04\b\x01\x10\x01B9Z7github.com/TheThingsIndustries/protoc-gen-go-flags/testb\x06proto3"
